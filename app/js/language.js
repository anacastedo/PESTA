...
$(function () {
    ...
    dictionary = {
        "english": {
            "_hi-hello":"Hi, ",
            "_menu-home": "Home",
            "_generateRep": "Generate Report",
            "_welcome": "Welcome to U=RIsolve Academy!",
            "_welcome1": "You came to the right place!",
            "_welcome2": "U=RIsolve Academy will be your 24/7 private Professor. :)",
            "_welcome3": "You have an overview of funcionalities on the right.",
            "_welcome4":   "However, below we list a few o them:",
            "_welcome5": "Train the most important Methods;",
            "_welcome6": "Get step-by-step solutions;",
            "_welcome7": "Practice by doing random exercises;",
            "_welcome8": "Follow customized study plans;",
            "_welcome9": "Submit your own electrical circuits;",
            "_welcome10": "AI adaptative exercises.",
            "_functionsTitle": "Check out what You can do:",
            "_study": "Study with your friends",
            "_share": "Easily share your circuits and analysis",
            "_watch": "Watch Video Tutorials",
            "_access": "Get access to quality video tutorials",
            "_smart": "Use it on your smartphone",
            "_smart2": "You can study using your smartphone",
            "_successTrack":"Enter in the success track",
            "_perfect": "Practice makes perfect",
            "_adaptative": "Adaptative learning",
            "_appLevel": "App will adapt to your level",
            "_stepByStep": "Step by Step Resolutions",
            "_simulatorRes": "App simulator gives a detailed resolution",
            "_startPractice":"Start practicing today!",
            "_selectType": "Select Exercise Type:",
            "_coming": "Coming soon",
            ...
            "_urisolveAcademy": "U=RIsolve Academy",
            "_training": "Training",
            "_simulator": "Simulator",
            "_aboutUrisolve": "About U=RIsolve",
            "_project": "Project",
            "_contacts": "Contacts",
            "_developer": "Admin Insights",
            "_analysisAdmin": "Quiz Admin",
            "_practice": "Practice",
            "_studyMaterial": "Study Materials",
            "_collab": "U=RIsolve is a collaborative Work!",
            "_join": "Join Us!",
            "_main-title_h1": "Circuit Simulator:",
            ...
            "_userScore":"Your current score is",
            "_sect_instruct": "Instructions",
            "_sect_examples": "Example circuits",
            "_sect_assisted":"Theme Study",
            "_sect_analysis":"Analysis Methods",
            "_sect_random":"Random Study",
            "_sect_contact": "Contact Us",
            "_sect_about": "About the Project",
            "_chooseMethod": "Choose Method Type:",
            "_chooseCur": "Choose Current Type:",
            "_chooseDif": "Choose Dificulty Level:",
            "_startQuiz": "Start Quiz",
            "_resetQuiz": "Reset Quiz",
            "_simpleStart": "Start",
            "_orSelectAQuiz": "Or Select a Quiz:",
            "_selectAQuizPlaceholder": "Select a Quiz",
            ...
            "_about_p1": "Learning circuit analysis is often a challenging issue for Electrical Engineering undergraduate students. During the course's early stages, procedures such as the correct identification of Branches, Nodes and Loops, the expression of Kirchhoff Current and Voltage Laws, as well as the application of analysis/simplification Theorems and Algorithms, usually embed tricky and error-prone steps for beginners. While circuit simulators offer a validation for theoretical and experimental analysis, they do not explain how to obtain the results nor the fundamental laws supporting them. In this regard, a new web-based framework, - dubbed U=RIsolve Academy (read as \"you resolve\") - for teaching and self-learning is now presented. The U=RIsolve Academy application goes far beyond the capabilities of traditional circuit simulators, as it outputs the fundamental information about the circuit, the methodology, the equations and the results related to the three main methods of analysis and also creates opportunities for autonomous and individualized study with its training module by methods or by themes.",
            ...
            "_fundamentals_M": "Meshes",
            "_fundamentals_C_T": "Currents and Voltage",
            "_fundamentalsTitle": "Fundamental Variables (of the circuit under analysis)",
            "_nodesOption": "A circuit is made up of several components that are joined together to form branches and nodes. In this section, you can learn how to correctly identify the number of nodes.",
            "_branchesOption": "In this section, you can learn how to correctly identify the number of branches in a circuit.",
            "_meshesOption": "In this section, you can learn how to correctly identify meshes with 2 or more branches.",
            "_equationsOption": "The number of equations and the equations chosen depend on the method chosen to solve the system. In this section, you will be able to assess your knowledge using the three circuit analysis methods.",
            "_CTOption": "Solving a circuit implies determining all currents and voltages. In this section, you'll be able to assess your ability to autonomously solve any circuit.",
            "_randomOption": "Get a random quiz regarding any method and any current type:",
            "_snTitle": "Supernodes",
            "_snNodes": "Formed by Nodes: ",
            "_snStepsBtn": "Show Steps",
            "_nbSteps": "Number of Steps",
            "_snEquat": "Equations: ",
            ...
            "_branchCurrents": "Branch Currents",
            ...
            "_question": "Question",
            "_answer": "Answer",
            "_answerError": "Answer does not exist in options",
            "_free": "Free",
            "_freeNum": "Free (numeric)",
            "_multiple": "Multiple",
            "_theme": "Theme",
            "_type": "Type of Answer",
            "_options": "Options",
            "_stepQuiz": "Step #",
            "_steps": "Steps",
            "_quizList": "Quiz List",
            "_addStep":"Add Step",
            "_updateQuiz": "Update Quiz",
            "_verifyAns": "Verify Answer",
            "_next": "Next",
            "_wrongAns": "Sorry, wrong answer!",
            "_wrongHint": "Please try again.",
            "_correct": "Correct!",
            "_endQuiz": "This is the end of the quiz. Thank you!",
            "_other": "Other",
            "_removeImage": "Clear Image",
            "_removeNetlist": "Clear Netlist",
            ...
            "_MTNmethod": "Node Voltage Method (Supernode approach)",
            ...
            "_abstractMTN": "This document provides a step by step solution for the submitted circuit, using the Branch Current Method (MTN).",
            ...
            "_circuitCurr": "Circuit Currents",
            "_KNLtext": "Equations using the Kirchhoff Nodes Law (KNL)",
            "_genInfo": "General Information",
            ...
            "_currentType": "Current Type",
            "_methodType": "Method Type",
            "_editQuiz": "Edit Quiz",
            "_editQuizNum": "Edit Quiz #",
            "_createQuiz": "Create Quiz",
            "_profile": "Profile",
            "_settings": "Settings",
            "_activity": "Activity Log",
            "_logout": "Logout",
            "_login": "Login",
            "_save": "Save",
            "_save_cont": "Save and Continue Editing",
        },
        ...
        "portuguese": {
            "_hi-hello":"Olá, ",
            "_menu-home":"Início",
            "_generateRep":"Gerar Relatório",
            "_welcome":"Bem-vindo(a) à Academia U=RIsolve!",
            "_welcome1":"Chegou ao local certo!",
            "_welcome2": "A Academia U=RIsolve vai ser o seu explicador privado 24/7. :)",
            "_welcome3": "Tem um resumo das funcionalidades à sua direita.",
            "_welcome4":  "No entanto, destacamos aqui algumas:",
            "_welcome5": "Treine os mais importantes Métodos;",
            "_welcome6": "Obtenha soluções passo a passo;",
            "_welcome7": "Pratique fazendo exercícios aleatórios;",
            "_welcome8": "Plano de estudo costumizado;",
            "_welcome9": "Submeta os seus circuitos;",
            "_welcome10": "Exercícios adaptados por IA.",
            "_coming": "Brevemente",
            "_functionsTitle": "Veja o que pode fazer aqui:",
            "_study": "Estude com amigos",
            "_share": "Partilhe facilmente os seus circuitos e análises",
            "_watch": "Veja tutoriais em vídeo",
            "_access": "Tenha acesso a tutoriais de qualidade",
            "_smart": "Pratique com o seu smartphone",
            "_smart2": "Pode estudar com o seu smartphone",
            "_successTrack":"Entre no caminho do sucesso",
            "_perfect": "A prática leva à perfeição",
            "_adaptative": "Aprendizagem adaptativa",
            "_appLevel": "A app adapta-se ao seu nível",
            "_stepByStep": "Soluções passo a passo",
            "_simulatorRes": "O simulador dá-lhe as resoluções detalhadas",
            "_startPractice": "Comece a praticar agora!",
            "_selectType": "Tipo de exercícios:",
            ...
            "_menu-movetop": "Topo",
            "_menu-account": "Conta",
            "_urisolveAcademy": "Academia U=RIsolve",
            "_training": "Treino",
            "_simulator": "Simulador",
            "_project": "Projeto",
            "_contacts": "Contactos",
            "_developer": "Ferramentas Admin",
            "_analysisAdmin": "Editor de Quizzes",
            "_practice": "Praticar",
            "_aboutUrisolve": "Sobre U=RIsolve",
            "_studyMaterial": "Materiais de Estudo",
            "_collab": "U=RIsolve é um projeto colaborativo",
            "_join": "Junte-se a nós!",
            "_main-title_h1": "Simulador de Circuitos:",
            ...
            "_userScore": "A sua pontuação atual é",
            "_sect_instruct": "Instruções",
            "_sect_examples": "Circuitos exemplo",
            "_sect_assisted": "Estudo por Temas",
            "_sect_analysis":"Métodos de Análise",
            "_sect_random":"Estudo Aleatório",
            "_sect_contact": "Contactar",
            "_sect_about": "Sobre o Projeto",
            "_chooseMethod": "Escolha o método de análise:",
            "_chooseCur": "Escolha o tipo de corrente:",
            "_chooseDif": "Escolha a dificuldade:",
            "_startQuiz": "Iniciar Quiz",
            "_resetQuiz": "Sair Quiz",
            "_simpleStart": "Começar",
            "_orSelectAQuiz": "Ou Escolha um Quiz: ",
            "_selectAQuizPlaceholder": "Escolha um Quiz",
            ...
            "_about_p1": "Aprender análise de circuitos costuma ser um desafio para alunos da Licenciatura em Engenharia Eletrotécnica. Durante as fases iniciais da licenciatura, procedimentos como a correta identificação de Ramos, Nós e Malhas, a expressão das Leis de Tensão e Corrente de Kirchhoff, bem como a aplicação de Teoremas e Algoritmos de análise/simplificação, geralmente incorporam etapas complicadas e propensas a erros para iniciantes. Embora os simuladores de circuitos ofereçam uma validação para análises teóricas e experimentais, eles não explicam como obter os resultados nem as leis fundamentais que os sustentam. Nesse sentido, uma nova framework baseada na web, - apelidada de Academia U=RIsolve (leia-se \"you resolve\") - para ensino e autoaprendizagem é agora apresentada. A Academia U=RIsolve vai muito além das capacidades dos simuladores de circuitos tradicionais, pois fornece as informações fundamentais do circuito, a metodologia, as equações e os resultados relacionados aos três principais métodos de análise e, ainda, cria oprtunidades de estudo autónomo e individualizado com o seu módulo de treino por métodos ou por temas.",
            ...
            "_fundamentals_M": "Malhas",
            "_fundamentals_C_T": "Correntes e Tensões",
            "_fundamentalsTitle": "Variáveis do Circuito",
            "_nodesOption": "Um circuito é composto por vários componentes que são unidos para formar ramos e nós. Nesta secção, poderá aprender a identificar corretamente o número de nós.",
            "_branchesOption": "Nesta secção, aprenderá como identificar corretamente o número de ramos num circuito.",
            "_meshesOption": "Nesta secção, poderá aprender como identificar corretamente malhas com 2 ou mais ramos.",
            "_equationsOption": "O número de equações e as equações escolhidas dependem do método escolhido para resolver o sistema. Nesta secção, será capaz de avaliar o seu conhecimento, utilizando os três métodos de análise de cicuitos.",
            "_CTOption": "Resolver um circuito implica determinar todas as correntes e tensões. Nesta secção, poderá avaliar a sua capacidade de resolver autonomamente qualquer circuito.",
            "_randomOption": "Obtenha um quiz aleatório relativo a qualquer método de análise e qualquer tipo de corrente:",
            "_snTitle": "Supernós",
            "_snNodes": "Constituído por: ",
            "_snStepsBtn": "Ver Etapas",
            "_nbSteps": "Número de Etapas",
            "_snEquat": "Equações: ",
            ...
            "_branchCurrents": "Correntes nos Ramos",
            ...
            "_question": "Pergunta",
            "_answer": "Resposta",
            "_answerError": "A resposta não existe nas opções",
            "_free": "Livre",
            "_freeNum": "Livre (numérica)",
            "_multiple": "Múltipla",
            "_theme": "Tema",
            "_type": "Tipo de Resposta",
            "_difficultyType": "Dificuldade",
            "_options": "Opções",
            "_stepQuiz": "Pergunta #",
            "_steps": "Perguntas",
            "_quizList": "Lista Quizzes",
            "_addStep":"Adicionar Pergunta",
            "_updateQuiz": "Atualizar Quiz",
            "_verifyAns": "Verificar Resposta",
            "_next": "Próxima",
            "_wrongAns": "Desculpa, resposta errada!",
            "_wrongHint": "Por favor, tenta outra vez.",
            "_correct": "Correta!",
            "_endQuiz": "Este é o fim do quiz. Obrigado!",
            "_other": "Outro",
            "_removeImage": "Apagar Imagem",
            "_removeNetlist": "Apagar Netlist",
            ...
            "_MTNmethod": "[pt] Método da Tensão nos Nós (com SuperNós)",
            ...
            "_abstractMTN": "Este documento fornece uma solução passo a passo para o circuito submetido, usando o Método da Tensão nos Nós (MTN)",
            ...
            "_circuitCurr": "Correntes do Circuito",
            "_genInfo": "Informação Geral",
            "_KNLtext": "Equações obtidas pela Lei de Kirchhoff para os Nós",
            ...
            "_singleeq": "Equação",
            "_table":"Tabela",
            "_reference": "Referência",
            "_startNode": "Nó Inicial",
            "_endNode": "Nó Final",
            "_components": "Componentes",
            "_currentType": "Tipo de Corrente",
            "_methodType": "Tipo de Método",
            "_editQuiz": "Editar Quiz",
            "_editQuizNum": "Editar Quiz #",
            "_createQuiz": "Criar Quiz",
            "_profile": "Perfil",
            "_logout": "Sair",
            "_login": "Entrar",
            ...
            "_activity": "Atividade",
            "_save": "Guardar",
            "_save_cont": "Guardar e continuar a Editar",
        }
    };
