<form method="post" id="amq-admin-form">
    ...
    <div class="input-grop-row">
        <div class="input-group">
            ...
            <div>
                <?php if ($quiz['netlist'] ?? ''): ?>
                <textarea readonly rows="10"><?php echo $quiz['netlist'] ?></textarea>
                    <button class="btn-clear-netlist" type="button" data-action="remove-netlist" data-translate="_removeNetlist"></button>
                    <input type="hidden" name="remove_netlist" value="0" />
                <?php endif; ?>
        ...
        <div class="input-group">
            ...
            <div>
                <?php if ($quiz['image'] ?? ''): ?>
                    ...
                    <button class="btn-clear-img" type="button" data-action="remove-quiz-img" data-translate="_removeImage"></button>
...
<style>
    ...
    #amq-admin-form .btn-clear-img, #amq-admin-form .btn-clear-netlist {
        margin: 10px 0 15px;
        color: var(--danger);
        background: none;
        padding: 0;
